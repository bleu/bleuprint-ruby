...
# source://rspec-support//lib/rspec/support/spec/formatting_support.rb#5
module RSpec::Support::FormattingSupport
  # source://rspec-support//lib/rspec/support/spec/formatting_support.rb#6
...
# source://rspec-support//lib/rspec/support/spec/in_sub_process.rb#5
module RSpec::Support::InSubProcess
  # Useful as a way to isolate a global change to a subprocess.
  #
  # source://rspec-support//lib/rspec/support/spec/in_sub_process.rb#12
  def in_sub_process(prevent_warnings = T.unsafe(nil)); end

  # Useful as a way to isolate a global change to a subprocess.
  #
  # source://rspec-support//lib/rspec/support/spec/in_sub_process.rb#12
  def in_sub_process_if_possible(prevent_warnings = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/spec/in_sub_process.rb#56
  def marshal_dump_with_unmarshable_object_handling(object); end
end

# source://rspec-support//lib/rspec/support/spec/in_sub_process.rb#8
class RSpec::Support::InSubProcess::UnmarshableObject < ::Struct
...
# source://rspec-support//lib/rspec/support/spec/diff_helpers.rb#7
module RSpec::Support::Spec
  class << self
    # source://rspec-support//lib/rspec/support/spec.rb#49
    def setup_simplecov(&block); end

    private

    # source://rspec-support//lib/rspec/support/spec.rb#68
    def start_simplecov(&block); end
  end
end

# source://rspec-support//lib/rspec/support/spec/diff_helpers.rb#8
module RSpec::Support::Spec::DiffHelpers
  # source://rspec-support//lib/rspec/support/spec/diff_helpers.rb#16
  def one_line_header(_ = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/spec/diff_helpers.rb#22
  def removing_two_line_header; end
end

# source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#7
class RSpec::Support::StdErrSplitter
  # @return [StdErrSplitter] a new instance of StdErrSplitter
  #
  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#8
  def initialize(original); end

  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#24
  def ==(other); end

  # @return [Boolean]
  #
  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#59
  def has_output?; end

  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#19
  def method_missing(name, *args, &block); end

  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#72
  def output; end

  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#28
  def reopen(*args); end

  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#63
  def reset!; end

  # To work around JRuby error:
  # can't convert RSpec::Support::StdErrSplitter into String
  #
  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#35
  def to_io; end

  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#67
  def verify_no_warnings!; end

  # To work around JRuby error:
  # TypeError: $stderr must have write method, RSpec::StdErrSplitter given
  #
  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#41
  def write(line); end

  private

  # source://rspec-support//lib/rspec/support/spec/stderr_splitter.rb#15
...
# source://rspec-support//lib/rspec/support/spec/with_isolated_stderr.rb#5
module RSpec::Support::WithIsolatedStdErr
  # source://rspec-support//lib/rspec/support/spec/with_isolated_stderr.rb#6
  def with_isolated_stderr; end
end
...
# source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#3
module RSpecHelpers
  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#24
  def allow_deprecation; end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#47
  def allow_warning; end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#4
  def expect_deprecation_with_call_site(file, line, snippet = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#9
  def expect_deprecation_without_call_site(snippet = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#28
  def expect_no_deprecation; end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#28
  def expect_no_deprecations; end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#43
  def expect_no_warnings; end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#19
  def expect_warn_deprecation(snippet = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#14
  def expect_warn_deprecation_with_call_site(file, line, snippet = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#38
  def expect_warning_with_call_site(file, line, expected = T.unsafe(nil)); end

  # source://rspec-support//lib/rspec/support/spec/deprecation_helpers.rb#33
  def expect_warning_without_call_site(expected = T.unsafe(nil)); end
end
